          ...
          <div className="bg-card border border-neon/30 p-8 rounded-lg shadow-[0_0_20px_rgba(255,165,0,0.2)] max-w-md w-full relative">
            ...
            <div className="space-y-6">
              <a href="tel:+919840018555" className="flex items-center gap-4 group p-4 rounded-lg border border-border hover:border-neon transition-all hover:bg-neon/5">
                <div className="w-12 h-12 rounded-full bg-background flex items-center justify-center text-muted-foreground group-hover:text-neon group-hover:shadow-[0_0_10px_rgba(255,165,0,0.3)] transition-all">
